...
const InviteModal: React.FC = () => {
  ...
  const sendInvitation = async (e: FormEvent) => {
    ...
    // New contract doesn't support invitations - players join directly
    toast.info('Invitations are not needed. Players can join games directly from the game list.')
    closeModal()
  }
